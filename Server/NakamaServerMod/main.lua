...
nk.register_rpc(backpack_service.rpc_inventory_get_all_info, "inventory_get_all_info")
...
nk.register_rpc(vip_svip_service.rpc_get_runtime_snapshot, "vip_runtime_snapshot")
